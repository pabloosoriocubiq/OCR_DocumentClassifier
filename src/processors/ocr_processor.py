...
class OCRProcessor:
    ...
    def extract_text_roi_strategy(self, image: Image.Image) -> Tuple[str, float, bool]:
        ...
        header_text, header_confidence = self.extract_text_from_region(header_region)
        
        has_useful_content = (
            header_confidence >= ROI_CONFIDENCE_THRESHOLD and 
            len(header_text) > 50 and
            len(header_text.strip()) > 20  # No solo espacios
        )
